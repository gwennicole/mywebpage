...
gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.doStepPreEventsContext.idToCallbackMap = new Map();
...
{for(var i = 0, len = gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.doStepPreEventsContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.doStepPreEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("PlatformerConfigurationStack")).RevertConfiguration("DiveDash", eventsFunctionContext);
}
}
...
gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.SimulateDiveKeyContext.idToCallbackMap = new Map();
...
for (var i = 0, k = 0, l = gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.SimulateDiveKeyContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.SimulateDiveKeyContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior")).CanDive(eventsFunctionContext) ) {
        isConditionTrue_0 = true;
...
gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.CanDiveContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__AdvancedJump__DiveDash.DiveDash.prototype.IsDivingContext.idToCallbackMap = new Map();
