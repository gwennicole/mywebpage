...
gdjs.evtsExt__PinchGesture__SetCameraPinchLayer.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(1).setString(eventsFunctionContext.getArgument("Layer"));
}
}
