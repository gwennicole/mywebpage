...
gdjs.evtsExt__PinchGesture__TouchCanvasX.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = gdjs.evtsExt__PinchGesture__TransformToCanvasX.func(runtimeScene, gdjs.evtTools.input.getTouchX(runtimeScene, eventsFunctionContext.getArgument("TouchId"), "", 0), gdjs.evtTools.input.getTouchY(runtimeScene, eventsFunctionContext.getArgument("TouchId"), "", 0), "", eventsFunctionContext);}
}
